...
/**
 * Class UserOrderSync
 * Håndterer synkronisering af brugerordrer med databasen.
 * Gemmer ordrer i en tilpasset database tabel og giver funktioner til at hente data.
 * @package SimpleMembers
 * @version 1.0.0
 */


if (!class_exists('UserOrderSync')) {
    class UserOrderSync {
